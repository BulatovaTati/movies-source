 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F=function(e){let t={},n={},i={},r="";try{const o=e.split(".");t=U(m(o[0])||""),n=U(m(o[1])||""),r=o[2],i=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:i,signature:r}},z=function(e){const t=F(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},j=function(e){const t=F(e).claims;return"object"==typeof t&&!0===t.admin};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const K="5",G=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Q="websocket",Y="long_polling";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ue;class Be extends Pe{static get __EMPTY_NODE(){return Ue}static set __EMPTY_NODE(e){Ue=e}compare(e,t){return L(e.name,t.name)}isDefinedOn(e){throw(0,s.assertionError)("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return De.MIN}maxPost(){return new De(A,Ue)}makePost(e,t){return(0,s.assert)("string"==typeof e,"KeyIndex indexValue must always be a string."),new De(e,Ue)}toString(){return".key"}}const Fe=new Be;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),a.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,o);r.forEach((r=>{r.respondsTo(n.type)&&t.push(r.createEvent(i,e.query_))}))}))}function Mt(e,t){return{eventCache:e,serverCache:t}}function Dt(e,t,n,i){return Mt(new Lt(t,n,i),e.serverCache)}function Pt(e,t,n,i){return Mt(e.eventCache,new Lt(t,n,i))}function Ut(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Bt(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let En,Tn;function Nn(e,t,n,i){const r=t.source.queryId;if(null!==r){const o=e.views.get(r);return(0,s.assert)(null!=o,"SyncTree gave us an op for an invalid query."),In(o,t,n,i)}{let r=[];for(const o of e.views.values())r=r.concat(In(o,t,n,i));return r}}function Sn(e,t){let n=null;for(const i of e.views.values())n=n||kn(i,t);return n}class Rn{constructor(e){this.listenProvider_=e,this.syncPointTree_=new zt(null),this.pendingWriteTree_={visibleWrites:jt.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function An(e,t,n,i,r){return function(e,t,n,i,r){(0,s.assert)(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=Wt(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?Un(e,new Rt({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Ln(e,t,n,i){!function(e,t,n,i){(0,s.assert)(i>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:i,visible:!0}),e.visibleWrites=qt(e.visibleWrites,t,n),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i);const r=zt.fromObject(n);return Un(e,new At({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,r))}function On(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Zt(e.pendingWriteTree_,t)){let t=new zt(null);return null!=i.snap?t=t.set(ge(),!0):U(i.children,(e=>{t=t.set(new me(e),!0)})),Un(e,new St(i.path,t,n))}return[]}function Mn(e,t,n){return Un(e,new Rt({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Dn(e,t,n,i){const r=zn(e,i);if(null!=r){const i=jn(r),o=i.path,s=i.queryId,a=Ce(o,t);return Wn(e,o,new Rt(Nt(s),a,n))}return[]}function Pn(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Sn(n,Ce(e,t));if(i)return i}));return rn(i,t,r,n,!0)}function Un(e,t){return Bn(t,e.syncPointTree_,null,Jt(e.pendingWriteTree_,ge()))}function Bn(e,t,n,i){if(Ie(e.path))return Fn(e,t,n,i);{const r=t.get(ge());null==n&&null!=r&&(n=Sn(r,ge()));let o=[];const s=ye(e.path),a=e.operationForChild(s),l=t.children.get(s);if(l&&a){const e=n?n.getImmediateChild(s):null,t=dn(i,s);o=o.concat(Bn(a,l,e,t))}return r&&(o=o.concat(Nn(r,e,i,n))),o}}function Fn(e,t,n,i){const r=t.get(ge());null==n&&null!=r&&(n=Sn(r,ge()));let o=[];return t.children.inorderTraversal(((t,r)=>{const s=n?n.getImmediateChild(t):null,a=dn(i,t),l=e.operationForChild(t);l&&(o=o.concat(Fn(l,r,s,a)))})),r&&(o=o.concat(Nn(r,e,i,n))),o}function zn(e,t){return e.tagToQueryMap.get(t)}function jn(e){const t=e.indexOf("$");return(0,s.assert)(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new me(e.substr(0,t))}}function Wn(e,t,n){const i=e.syncPointTree_.get(t);(0,s.assert)(i,"Missing sync point for query tag that we're tracking");return Nn(i,n,Jt(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class vi{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function bi(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],o=r.getPath();null===n||Te(o,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:o}),n.events.push(r)}n&&e.eventLists_.push(n)}function _i(e,t,n){bi(e,n),wi(e,(e=>Ne(e,t)||Ne(t,e)))}function wi(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(xi(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function xi(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();w&&I("event: "+n.toString()),q(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(e){return 1e3*Number(e)}function z(e){var t;const[n,r,o]=e.split(".");if(void 0===n||void 0===r||void 0===o)return f("JWT malformed, contained fewer than 3 sections"),null;try{const e=(0,i.base64Decode)(r);return e?JSON.parse(e):(f("Failed to decode base64 JWT payload"),null)}catch(e){return f("Caught error parsing JWT payload as JSON",null===(t=e)||void 0===t?void 0:t.toString()),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=new E(3e4,6e4);function Bt(){const e=Ze().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Ft=null;function zt(e){return Ft=Ft||function(e){return new Promise(((t,n)=>{var i,r,o;function s(){Bt(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Bt(),n(m(e,"network-request-failed"))},timeout:Ut.get()})}if(null===(r=null===(i=Ze().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Ze().gapi)||void 0===o?void 0:o.load)){const t=ht("iframefcb");return Ze()[t]=()=>{gapi.load?s():n(m(e,"network-request-failed"))},dt(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Ft=null,e}))}(e),Ft}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${(0,i.querystring)(c).slice(1)}`}const Qt="webStorageSupport";const Yt=class{async _openPopup(e,t,n,i){var r;_(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return Xt(e,Gt(e,t,n,k(),i),Ye())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=Gt(e,t,n,k(),i),Ze().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(_(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await zt(e),n=Ze().gapi;return v(n,e,"internal-error"),t.open({where:document.body,url:Ht(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Wt,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=m(e,"network-request-failed"),o=Ze().setTimeout((()=>{i(r)}),jt.get());function s(){Ze().clearTimeout(o),n(t)}t.ping(s).then(s,(()=>{i(r)}))}))))}(e),n=new Rt(e);return t.register("authEvent",(t=>{v(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Qt,{type:Qt},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),p(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Dt(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ae()||ee()||se()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ge,this._completeRedirectFn=St,this._overrideRedirectResult=Et}};var Jt="@firebase/auth",Zt="0.20.10";
/**
 * @license
 * Copyright 2020 Google LLC
 *
